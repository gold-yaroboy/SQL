...
(
	...
	--https://stackoverflow.com/questions/7017871/one-of-the-column-between-two-columns-should-be-not-null-how-to-enforce-it-in-s
	--CONSTRAINT CK_Null_HW CHECK([data] is not NULL or comment is NOT NULL)
)
